function wordRank(str) {
    /*  Objetivo da função é 
      ...
      2- A pontuação (de acordo com o desafio) de todas as palavras registradas desse Array são atribuidas a um novo array na mesma ordem utilizando de loops for
      3- Por fim a função busca pelo maior valor no array das pontuacoes e como as posições de ambos os arrays são as mesmas basta chamar o array da frase com o index do maior valor do array com as pontuações
    */
